...
.. py:class:: U32Vector2
    ...
    .. py:method:: __init__()
        ...
        Initializes a U32Vector2 with :code:`0` in all component positions.


    .. py:method:: __init__(all: Number, /)
        :no-index:

        Initializes a U32Vector2 with :code:`all` in all component positions.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`U32Vector2` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`uint32_t[2]`.
    ...
    .. py:method:: __add__(other: U32Vector2) -> U32Vector2

        Add the two vectors together, component-wise.


    .. py:method:: __add__(other: Number) -> U32Vector2
        :no-index:

        Add the number to each component of the vector.


    .. py:method:: __sub__(other: U32Vector2) -> U32Vector2

        Subtract two vectors from each other, component-wise.


    .. py:method:: __sub__(other: Number) -> U32Vector2
        :no-index:

        Subtract the number from each component of the vector.


    .. py:method:: __mul__(other: U32Vector2) -> U32Vector2

        Multiple the two vectors, component-wise.


    .. py:method:: __mul__(other: Number) -> U32Vector2
        :no-index:
    ...
    .. py:method:: __truediv__(other: U32Vector2) -> U32Vector2

        Divide the two vectors, component-wise.


    .. py:method:: __truediv__(other: Number) -> U32Vector2
        :no-index:
    ...
    .. py:method:: __neg__() -> U32Vector2

        Returns a new vector with each component's sign flipped.


    .. py:method:: __abs__() -> U32Vector2
    ...
    .. py:method:: get_array_type() -> type[U32Vector2Array]
        :classmethod:
...
.. c:function:: PyObject *U32Vector2_Create(const uint32_t *value)

    Returns a new :py:class:`U32Vector2` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads 2 uint32_ts from the pointer.


.. c:function:: const uint32_t *U32Vector2_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`U32Vector2`. The lifetime of this
    pointer is tied to the :py:class:`U32Vector2` object.


.. c:function:: PyTypeObject *U32Vector2_GetType()

    Returns the type object of :py:class:`U32Vector2`.
