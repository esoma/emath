...
static PyObject *
{{ name }}Array_from_buffer(PyTypeObject *cls, PyObject *args, PyObject *kwargs)
{
    ...
    static Py_ssize_t element_size = sizeof({{ c_type }}) * {{ component_count }};
...
static PyMethodDef {{ name }}Array_PyMethodDef[] = {
    {"from_buffer", (PyCFunction){{ name }}Array_from_buffer, METH_VARARGS | METH_KEYWORDS | METH_CLASS, 0},
