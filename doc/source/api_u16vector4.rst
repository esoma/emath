...
.. py:class:: U16Vector4
    ...
    .. py:method:: __init__()
        ...
        Initializes a U16Vector4 with :code:`0` in all component positions.


    .. py:method:: __init__(all: Number, /)
        :no-index:

        Initializes a U16Vector4 with :code:`all` in all component positions.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`U16Vector4` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`uint16_t[4]`.
    ...
    .. py:method:: __add__(other: U16Vector4) -> U16Vector4

        Add the two vectors together, component-wise.


    .. py:method:: __add__(other: Number) -> U16Vector4
        :no-index:

        Add the number to each component of the vector.


    .. py:method:: __sub__(other: U16Vector4) -> U16Vector4

        Subtract two vectors from each other, component-wise.


    .. py:method:: __sub__(other: Number) -> U16Vector4
        :no-index:

        Subtract the number from each component of the vector.


    .. py:method:: __mul__(other: U16Vector4) -> U16Vector4

        Multiple the two vectors, component-wise.


    .. py:method:: __mul__(other: Number) -> U16Vector4
        :no-index:
    ...
    .. py:method:: __truediv__(other: U16Vector4) -> U16Vector4

        Divide the two vectors, component-wise.


    .. py:method:: __truediv__(other: Number) -> U16Vector4
        :no-index:
    ...
    .. py:method:: get_array_type() -> type[U16Vector4Array]
        :classmethod:

        Returns the emath class used to create an array of this vector type.


    .. py:method:: from_buffer(buffer: Buffer, /) -> U16Vector4
        :classmethod:
...
.. c:function:: PyObject *U16Vector4_Create(const uint16_t *value)

    Returns a new :py:class:`U16Vector4` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads 4 uint16_ts from the pointer.


.. c:function:: const uint16_t *U16Vector4_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`U16Vector4`. The lifetime of this
    pointer is tied to the :py:class:`U16Vector4` object.


.. c:function:: PyTypeObject *U16Vector4_GetType()

    Returns the type object of :py:class:`U16Vector4`.
