...
.. py:class:: DVector4Array

    .. py:method:: __init__(*vectors: DVector4)

        Initializes a DVector4Array composed of the vectors provided.
    ...
    .. py:method:: count(value: DVector4) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: DVector4, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`DVector4Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`double[4 * length]`.
    ...
    .. py:method:: get_component_type() -> type[DVector4]
        :classmethod:
    ...
    .. py:method:: from_buffer(buffer: Buffer, /) -> DVector4
        ...
        :code:`double[4 * length]`.


C API
-----

.. c:function:: PyObject *DVector4Array_Create(size_t length, const double *value)

    Returns a new :py:class:`DVector4Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`4 * length` doubles from the pointer.


.. c:function:: const double *DVector4Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`DVector4Array`. The lifetime of this
    pointer is tied to the :py:class:`DVector4Array` object.


.. c:function:: size_t DVector4Array_GetLength()

    Returns the number of vectors in the :py:class:`DVector4Array` object.


.. c:function:: PyTypeObject *DVector4Array_GetType()

    Returns the type object of :py:class:`DVector4Array`.
