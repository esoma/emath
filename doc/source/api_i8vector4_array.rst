...
.. py:class:: I8Vector4Array

    .. py:method:: __init__(*vectors: I8Vector4)

        Initializes a I8Vector4Array composed of the vectors provided.
    ...
    .. py:method:: count(value: I8Vector4) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: I8Vector4, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`I8Vector4Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`int8_t[4 * length]`.
    ...
    .. py:method:: get_component_type() -> type[I8Vector4]
        :classmethod:
    ...
    .. py:method:: from_buffer(buffer: Buffer, /) -> I8Vector4
        ...
        :code:`int8_t[4 * length]`.


C API
-----

.. c:function:: PyObject *I8Vector4Array_Create(size_t length, const int8_t *value)

    Returns a new :py:class:`I8Vector4Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`4 * length` int8_ts from the pointer.


.. c:function:: const int8_t *I8Vector4Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`I8Vector4Array`. The lifetime of this
    pointer is tied to the :py:class:`I8Vector4Array` object.


.. c:function:: size_t I8Vector4Array_GetLength()

    Returns the number of vectors in the :py:class:`I8Vector4Array` object.


.. c:function:: PyTypeObject *I8Vector4Array_GetType()

    Returns the type object of :py:class:`I8Vector4Array`.
