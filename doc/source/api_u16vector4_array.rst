...
.. py:class:: U16Vector4Array

    .. py:method:: __init__(*vectors: U16Vector4)

        Initializes a U16Vector4Array composed of the vectors provided.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`U16Vector4Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`uint16_t[4 * length]`.
    ...
    .. py:method:: get_component_type() -> type[U16Vector4]
        :classmethod:
    ...
    .. py:method:: from_buffer(buffer: Buffer, /) -> U16Vector4
        ...
        :code:`uint16_t[4 * length]`.


C API
-----

.. c:function:: PyObject *U16Vector4Array_Create(size_t length, const uint16_t *value)

    Returns a new :py:class:`U16Vector4Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`4 * length` uint16_ts from the pointer.


.. c:function:: const uint16_t *U16Vector4Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`U16Vector4Array`. The lifetime of this
    pointer is tied to the :py:class:`U16Vector4Array` object.


.. c:function:: size_t U16Vector4Array_GetLength()

    Returns the number of vectors in the :py:class:`U16Vector4Array` object.


.. c:function:: PyTypeObject *U16Vector4Array_GetType()

    Returns the type object of :py:class:`U16Vector4Array`.
