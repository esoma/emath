...
.. py:class:: FVector4
    ...
    .. py:method:: __init__()
        ...
        Initializes a FVector4 with :code:`0` in all component positions.


    .. py:method:: __init__(all: Number, /)
        :no-index:

        Initializes a FVector4 with :code:`all` in all component positions.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`FVector4` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`float[4]`.
    ...
    .. py:method:: __truediv__(other: FVector4) -> FVector4

        Divide the two vectors, component-wise.


    .. py:method:: __truediv__(other: Number) -> FVector4
        :no-index:
    ...
    .. py:method:: normalize() -> FVector4

        Computes a normalized vector.


    .. py:method:: distance(other: FVector4, /) -> float

        Computes the distance between the two vectors.


    .. py:method:: lerp(other: FVector4, t: float, /) -> FVector4
    ...
    .. py:method:: get_array_type() -> type[FVector4Array]
        :classmethod:

        Returns the emath class used to create an array of this vector type.


    .. py:method:: from_buffer(buffer: Buffer, /) -> FVector4
        :classmethod:
...
.. c:function:: PyObject *FVector4_Create(const float *value)

    Returns a new :py:class:`FVector4` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads 4 floats from the pointer.


.. c:function:: const float *FVector4_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`FVector4`. The lifetime of this
    pointer is tied to the :py:class:`FVector4` object.


.. c:function:: PyTypeObject *FVector4_GetType()

    Returns the type object of :py:class:`FVector4`.
