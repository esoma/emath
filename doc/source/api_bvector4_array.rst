...
.. py:class:: BVector4Array

    .. py:method:: __init__(*vectors: BVector4)

        Initializes a BVector4Array composed of the vectors provided.
    ...
    .. py:method:: count(value: BVector4) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: BVector4, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`BVector4Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`bool[4 * length]`.
    ...
    .. py:method:: get_component_type() -> type[BVector4]
        :classmethod:
...
.. c:function:: PyObject *BVector4Array_Create(size_t length, const bool *value)

    Returns a new :py:class:`BVector4Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`4 * length` bools from the pointer.


.. c:function:: const bool *BVector4Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`BVector4Array`. The lifetime of this
    pointer is tied to the :py:class:`BVector4Array` object.


.. c:function:: size_t BVector4Array_GetLength()

    Returns the number of vectors in the :py:class:`BVector4Array` object.


.. c:function:: PyTypeObject *BVector4Array_GetType()

    Returns the type object of :py:class:`BVector4Array`.
