...
.. py:class:: U8Vector1
    ...
    .. py:method:: __init__()
        ...
        Initializes a U8Vector1 with :code:`0` in all component positions.


    .. py:method:: __init__(x: Number, /)
        :no-index:

        Initializes a U8Vector1.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`U8Vector1` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`uint8_t[1]`.
    ...
    .. py:method:: __add__(other: U8Vector1) -> U8Vector1

        Add the two vectors together, component-wise.


    .. py:method:: __add__(other: Number) -> U8Vector1
        :no-index:

        Add the number to each component of the vector.


    .. py:method:: __sub__(other: U8Vector1) -> U8Vector1

        Subtract two vectors from each other, component-wise.


    .. py:method:: __sub__(other: Number) -> U8Vector1
        :no-index:

        Subtract the number from each component of the vector.


    .. py:method:: __mul__(other: U8Vector1) -> U8Vector1

        Multiple the two vectors, component-wise.


    .. py:method:: __mul__(other: Number) -> U8Vector1
        :no-index:
    ...
    .. py:method:: __truediv__(other: U8Vector1) -> U8Vector1

        Divide the two vectors, component-wise.


    .. py:method:: __truediv__(other: Number) -> U8Vector1
        :no-index:
    ...
    .. py:method:: get_array_type() -> type[U8Vector1Array]
        :classmethod:
...
.. c:function:: PyObject *U8Vector1_Create(const uint8_t *value)

    Returns a new :py:class:`U8Vector1` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads 1 uint8_t from the pointer.


.. c:function:: const uint8_t *U8Vector1_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`U8Vector1`. The lifetime of this
    pointer is tied to the :py:class:`U8Vector1` object.


.. c:function:: PyTypeObject *U8Vector1_GetType()

    Returns the type object of :py:class:`U8Vector1`.
