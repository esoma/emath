...
from emath import BVector2Array
from emath import BVector3
from emath import BVector3Array
from emath import BVector4
from emath import BVector4Array
from emath import DQuaternion
from emath import DVector1
from emath import DVector1Array
from emath import DVector2
from emath import DVector2Array
from emath import DVector3
from emath import DVector3Array
from emath import DVector4
from emath import DVector4Array
from emath import FQuaternion
from emath import FVector1
from emath import FVector1Array
...
from emath import I8Vector1
from emath import I8Vector1Array
from emath import I8Vector2
from emath import I8Vector2Array
from emath import I8Vector3
from emath import I8Vector3Array
from emath import I8Vector4
from emath import I8Vector4Array
from emath import I16Vector1
from emath import I16Vector1Array
from emath import I16Vector2
from emath import I16Vector2Array
from emath import I16Vector3
from emath import I16Vector3Array
from emath import I16Vector4
from emath import I16Vector4Array
from emath import I32Vector1
from emath import I32Vector1Array
from emath import I32Vector2
from emath import I32Vector2Array
from emath import I32Vector3
from emath import I32Vector3Array
from emath import I32Vector4
from emath import I32Vector4Array
from emath import I64Vector1
from emath import I64Vector1Array
from emath import I64Vector2
from emath import I64Vector2Array
from emath import I64Vector3
from emath import I64Vector3Array
from emath import I64Vector4
from emath import I64Vector4Array
from emath import IVector1
from emath import IVector1Array
from emath import IVector2
from emath import IVector2Array
from emath import IVector3
from emath import IVector3Array
from emath import IVector4
from emath import IVector4Array
from emath import U8Vector1
from emath import U8Vector1Array
from emath import U8Vector2
from emath import U8Vector2Array
from emath import U8Vector3
from emath import U8Vector3Array
from emath import U8Vector4
from emath import U8Vector4Array
from emath import U16Vector1
from emath import U16Vector1Array
from emath import U16Vector2
from emath import U16Vector2Array
from emath import U16Vector3
from emath import U16Vector3Array
from emath import U16Vector4
from emath import U16Vector4Array
from emath import U32Vector1
from emath import U32Vector1Array
from emath import U32Vector2
from emath import U32Vector2Array
from emath import U32Vector3
from emath import U32Vector3Array
from emath import U32Vector4
from emath import U32Vector4Array
from emath import U64Vector1
from emath import U64Vector1Array
from emath import U64Vector2
from emath import U64Vector2Array
from emath import U64Vector3
from emath import U64Vector3Array
from emath import U64Vector4
from emath import U64Vector4Array
from emath import UVector1
from emath import UVector1Array
from emath import UVector2
from emath import UVector2Array
from emath import UVector3
...
class VectorTest:
        ...
        for i in range(2, 5):
            for attrs in itertools.combinations_with_replacement(good, i):
                ...
                swizzle_type = globals()[
                    self.cls.__name__[: self.cls.__name__.find("V")] + f"Vector{i}"
                ]
    ...
    def test_hash(self) -> None:
        ...
        assert hash(self.cls(0)) != hash(self.cls(*range(1, self.component_count + 1)))

    def test_array_hash(self) -> None:
        assert hash(self.array_cls()) != hash(self.array_cls(self.cls(0)))
        assert hash(self.array_cls(self.cls(0))) != hash(self.array_cls(self.cls(1)))
        assert hash(self.array_cls(self.cls(1))) == hash(self.array_cls(self.cls(1)))
        if self.type != bool and not self.unsigned:
            assert hash(self.array_cls(self.cls(-1))) != (hash(self.array_cls(self.cls(1))))
    ...
    def test_array_repr(self) -> None:
        ...
        assert repr(self.array_cls(self.cls())) == (f"{self.array_cls.__name__}[1]")
    ...
    def test_array_equal(self) -> None:
        ...
        for i in range(0 if self.unsigned else -100, 100):
            ...
            assert not (self.array_cls(self.cls(i), self.cls(i)) == self.array_cls(self.cls(i)))
    ...
    def test_array_not_equal(self) -> None:
        ...
        for i in range(0 if self.unsigned else -100, 100):
            assert not (self.array_cls(self.cls(i)) != self.array_cls(self.cls(i)))
            assert self.array_cls(self.cls(i), self.cls(i)) != self.array_cls(self.cls(i))
    ...
    def test_less_than(self) -> None:
        if self.type == bool:
            ...
            for x in range(self.component_count):
                assert self.cls(*(i + 1 for i in range(self.component_count))) < self.cls(
                    *(i + 2 if i == x else i + 1 for i in range(self.component_count))
                )
                assert not (
                    self.cls(*(i + 2 if i == x else i + 1 for i in range(self.component_count)))
                    < self.cls(*(i + 1 for i in range(self.component_count)))
                )
    ...
    def test_less_than_equal(self) -> None:
        if self.type == bool:
            ...
            for x in range(self.component_count):
                assert self.cls(*(i + 1 for i in range(self.component_count))) <= self.cls(
                    *(i + 3 if i == x else i + 2 for i in range(self.component_count))
                )
                assert not (
                    self.cls(*(i + 3 if i == x else i + 2 for i in range(self.component_count)))
                    <= self.cls(*(i + 1 for i in range(self.component_count)))
                )
    ...
    def test_greater_than(self) -> None:
        if self.type == bool:
            ...
            assert not (self.cls(0) > self.cls(1))
            for x in range(self.component_count):
                assert self.cls(*(i + 2 for i in range(self.component_count))) > self.cls(
                    *(i + 1 if i == x else i + 2 for i in range(self.component_count))
                )
                assert not (
                    self.cls(*(i + 1 if i == x else i + 2 for i in range(self.component_count)))
    ...
    def test_greater_than_equal(self) -> None:
        if self.type == bool:
            ...
            assert not (self.cls(0) >= self.cls(1))
            for x in range(self.component_count):
                assert self.cls(*(i + 3 for i in range(self.component_count))) >= self.cls(
                    *(i + 3 if i == x else i + 2 for i in range(self.component_count))
                )
                assert not (
                    self.cls(*(i + 1 if i == x else i + 2 for i in range(self.component_count)))
    ...
    def test_add(self) -> None:
        if not self.unsigned:
            ...
            assert self.cls(1) + self.cls(-1) == self.cls(self.type(1) + self.type(-1))
            ...
            assert self.cls(self.cls.get_limits()[1]) + self.cls(1) == self.cls(
                self.cls.get_limits()[0]
            )
        assert self.cls(1) + self.cls(1) == self.cls(2)
        assert self.cls(1) + 1 == self.cls(2)
        assert 1 + self.cls(1) == self.cls(2)
        ...
        vector = self.cls(*range(self.component_count))
        assert vector + vector == self.cls(*(i + i for i in range(self.component_count)))
        assert vector + 1 == self.cls(*(i + 1 for i in range(self.component_count)))
        assert 1 + vector == self.cls(*(1 + i for i in range(self.component_count)))

        i_vec = vector
        i_vec += vector
        assert i_vec is not vector
        assert vector == self.cls(*range(self.component_count))
        assert i_vec == self.cls(*(i + i for i in range(self.component_count)))

        i_vec = vector
        i_vec += 1
        assert i_vec is not vector
        assert vector == self.cls(*range(self.component_count))
        assert i_vec == self.cls(*(i + 1 for i in range(self.component_count)))
    ...
    def test_subtract(self) -> None:
        if not self.unsigned:
            ...
            assert self.cls(0) - self.cls(1) == self.cls(self.cls.get_limits()[1])
        assert self.cls(1) - self.cls(1) == self.cls(0)
        assert self.cls(1) - 1 == self.cls(0)
        assert 1 - self.cls(1) == self.cls(0)

        vector = self.cls(*range(1, self.component_count + 1))
        assert vector - vector == self.cls(*(i - i for i in range(1, self.component_count + 1)))
        assert vector - 1 == self.cls(
            *(self.type(i) - self.type(1) for i in range(1, self.component_count + 1))
        )
        assert 5 - vector == self.cls(
            *(self.type(5) - self.type(i) for i in range(1, self.component_count + 1))
        )
        ...
        assert i_vec == self.cls(*(i - i for i in range(1, self.component_count + 1)))
    ...
    def test_multiply(self) -> None:
        if not self.unsigned:
            ...
            assert self.cls(self.cls.get_limits()[1]) * self.cls(2) == self.cls(
                self.cls.get_limits()[1] - 1
            )
        assert self.cls(1) * self.cls(2) == self.cls(2)
        assert self.cls(1) * 2 == self.cls(2)
        assert 2 * self.cls(1) == self.cls(2)
        ...
        vector = self.cls(*range(self.component_count))
        assert vector * vector == self.cls(*(i * i for i in range(self.component_count)))
        assert vector * 2 == self.cls(*(i * 2 for i in range(self.component_count)))
        assert 2 * vector == self.cls(*(2 * i for i in range(self.component_count)))
        ...
        assert i_vec is not vector
        assert vector == self.cls(*range(self.component_count))
        assert i_vec == self.cls(*(i * 2 for i in range(self.component_count)))
    ...
    def test_matrix_multiply(self) -> None:
        ...
        assert self.cls(1) @ self.cls(1) == sum(
            self.cls(1)[i] * self.cls(1)[i] for i in range(self.component_count)
        )
        assert self.cls(2) @ self.cls(2) == sum(
            self.cls(2)[i] * self.cls(2)[i] for i in range(self.component_count)
        )
        ...
        assert i_vec is not vector
        assert vector == self.cls(*range(self.component_count))
        assert i_vec == sum(vector[i] * vector[i] for i in range(self.component_count))
    ...
    def test_divide(self) -> None:
        ...
        if not self.unsigned:
            assert self.cls(-1) / self.cls(-2) == self.cls(self.type(0.5))
            assert self.cls(-1) / -2 == self.cls(self.type(0.5))
            assert -1 / self.cls(-2) == self.cls(self.type(0.5))
            assert self.cls(1) / self.cls(-2) == self.cls(self.type(-0.5))
            assert self.cls(1) / -2 == self.cls(self.type(-0.5))
            assert 1 / self.cls(-2) == self.cls(self.type(-0.5))
        ...
        assert i_vec is not vector
        assert vector == self.cls(*range(1, self.component_count + 1))
        assert i_vec == self.cls(*(self.type(i / i) for i in range(1, self.component_count + 1)))

        i_vec = vector
        i_vec /= 2
        assert i_vec is not vector
        assert vector == self.cls(*range(1, self.component_count + 1))
        assert i_vec == self.cls(*(self.type(i / 2) for i in range(1, self.component_count + 1)))
    ...
    def test_modulus(self) -> None:
        ...
        vector = self.cls(*range(1, self.component_count + 1))
        assert vector % vector == self.cls(*(i % i for i in range(1, self.component_count + 1)))
        assert vector % 2 == self.cls(*(i % 2 for i in range(1, self.component_count + 1)))
        assert 2 % vector == self.cls(*(2 % i for i in range(1, self.component_count + 1)))
        ...
        assert i_vec is not vector
        assert vector == self.cls(*range(1, self.component_count + 1))
        assert i_vec == self.cls(*(i % 2 for i in range(1, self.component_count + 1)))
    ...
    def test_negative(self) -> None:
        ...
        vector = self.cls(*range(self.component_count))
        assert -vector == self.cls(*(-i for i in range(self.component_count)))
    ...
    def test_buffer(self) -> None:
        assert bytes(self.cls(*range(self.component_count))) == struct.pack(
            self.struct_byte_order + (self.struct_format * self.component_count),
    ...
    def test_array_buffer(self) -> None:
        ...
        assert memory_view.strides == (
            struct.calcsize(self.struct_byte_order + self.struct_format) * self.component_count,
            struct.calcsize(self.struct_byte_order + self.struct_format),
        )
        assert memory_view.suboffsets == tuple()
        assert memory_view.c_contiguous
    ...
    def test_cross(self) -> None:
        ...
        assert self.cls(1).cross(self.cls(-1)) == self.cls(0)
        assert self.cls(1, 2, 3).cross(self.cls(4, 5, 6)) == (self.cls(-3, 6, -3))
    ...
    def test_array_size(self) -> None:
        ...
        assert self.array_cls(self.cls(), self.cls()).size == (
            struct.calcsize("=" + self.struct_format) * self.component_count * 2
        )

    def test_from_buffer(self) -> None:
        for v in (self.cls(), self.cls(1), self.cls(*range(self.component_count))):
    ...
    def test_from_array_buffer(self) -> None:
        for a in (
            ...
            self.array_cls(self.cls(1), self.cls(*range(self.component_count))),
        ):
...
class TestDVector1(VectorTest, cls=DVector1, component_count=1, type=float, struct_format="d"):
    pass


class TestFVector1(VectorTest, cls=FVector1, component_count=1, type=float, struct_format="f"):
    pass
...
class TestIVector1(VectorTest, cls=IVector1, component_count=1, type=int, struct_format="i"):
    pass


class TestUVector1(
    VectorTest, cls=UVector1, component_count=1, type=int, struct_format="I", unsigned=True
):
    pass
...
class TestBVector2(VectorTest, cls=BVector2, component_count=2, type=bool, struct_format="?"):
    pass


class TestDVector2(VectorTest, cls=DVector2, component_count=2, type=float, struct_format="d"):
    pass


class TestFVector2(VectorTest, cls=FVector2, component_count=2, type=float, struct_format="f"):
    pass
...
class TestIVector2(VectorTest, cls=IVector2, component_count=2, type=int, struct_format="i"):
    pass


class TestUVector2(
    VectorTest, cls=UVector2, component_count=2, type=int, struct_format="I", unsigned=True
):
    pass
...
class TestBVector3(VectorTest, cls=BVector3, component_count=3, type=bool, struct_format="?"):
    pass


class TestDVector3(VectorTest, cls=DVector3, component_count=3, type=float, struct_format="d"):
    pass


class TestFVector3(VectorTest, cls=FVector3, component_count=3, type=float, struct_format="f"):
    pass
...
class TestIVector3(VectorTest, cls=IVector3, component_count=3, type=int, struct_format="i"):
    pass


class TestUVector3(
    VectorTest, cls=UVector3, component_count=3, type=int, struct_format="I", unsigned=True
):
    pass
...
class TestBVector4(VectorTest, cls=BVector4, component_count=4, type=bool, struct_format="?"):
    pass


class TestDVector4(VectorTest, cls=DVector4, component_count=4, type=float, struct_format="d"):
    pass


class TestFVector4(VectorTest, cls=FVector4, component_count=4, type=float, struct_format="f"):
    pass
...
class TestIVector4(VectorTest, cls=IVector4, component_count=4, type=int, struct_format="i"):
    pass


class TestUVector4(
    VectorTest, cls=UVector4, component_count=4, type=int, struct_format="I", unsigned=True
):
    pass
