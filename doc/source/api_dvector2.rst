...
.. py:class:: DVector2
    ...
    .. py:method:: __init__()
        ...
        Initializes a DVector2 with :code:`0` in all component positions.


    .. py:method:: __init__(all: Number, /)
        :no-index:

        Initializes a DVector2 with :code:`all` in all component positions.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`DVector2` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`double[2]`.
    ...
    .. py:method:: __add__(other: DVector2) -> DVector2

        Add the two vectors together, component-wise.


    .. py:method:: __add__(other: Number) -> DVector2
        :no-index:

        Add the number to each component of the vector.


    .. py:method:: __sub__(other: DVector2) -> DVector2

        Subtract two vectors from each other, component-wise.


    .. py:method:: __sub__(other: Number) -> DVector2
        :no-index:

        Subtract the number from each component of the vector.


    .. py:method:: __mul__(other: DVector2) -> DVector2

        Multiple the two vectors, component-wise.


    .. py:method:: __mul__(other: Number) -> DVector2
        :no-index:
    ...
    .. py:method:: __truediv__(other: DVector2) -> DVector2

        Divide the two vectors, component-wise.


    .. py:method:: __truediv__(other: Number) -> DVector2
        :no-index:
    ...
    .. py:method:: get_array_type() -> type[DVector2Array]
        :classmethod:

        Returns the emath class used to create an array of this vector type.


    .. py:method:: from_buffer(buffer: Buffer, /) -> DVector2
        :classmethod:
...
.. c:function:: PyObject *DVector2_Create(const double *value)

    Returns a new :py:class:`DVector2` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads 2 doubles from the pointer.


.. c:function:: const double *DVector2_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`DVector2`. The lifetime of this
    pointer is tied to the :py:class:`DVector2` object.


.. c:function:: PyTypeObject *DVector2_GetType()

    Returns the type object of :py:class:`DVector2`.
