...
.. py:class:: U8Vector3
    ...
    .. py:method:: __init__()
        ...
        Initializes a U8Vector3 with :code:`0` in all component positions.


    .. py:method:: __init__(all: Number, /)
        :no-index:

        Initializes a U8Vector3 with :code:`all` in all component positions.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`U8Vector3` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`uint8_t[3]`.
    ...
    .. py:method:: __add__(other: U8Vector3) -> U8Vector3

        Add the two vectors together, component-wise.


    .. py:method:: __add__(other: Number) -> U8Vector3
        :no-index:

        Add the number to each component of the vector.


    .. py:method:: __sub__(other: U8Vector3) -> U8Vector3

        Subtract two vectors from each other, component-wise.


    .. py:method:: __sub__(other: Number) -> U8Vector3
        :no-index:

        Subtract the number from each component of the vector.


    .. py:method:: __mul__(other: U8Vector3) -> U8Vector3

        Multiple the two vectors, component-wise.


    .. py:method:: __mul__(other: Number) -> U8Vector3
        :no-index:
    ...
    .. py:method:: __truediv__(other: U8Vector3) -> U8Vector3

        Divide the two vectors, component-wise.


    .. py:method:: __truediv__(other: Number) -> U8Vector3
        :no-index:
    ...
    .. py:method:: get_array_type() -> type[U8Vector3Array]
        :classmethod:

        Returns the emath class used to create an array of this vector type.


    .. py:method:: from_buffer(buffer: Buffer, /) -> U8Vector3
        :classmethod:
...
.. c:function:: PyObject *U8Vector3_Create(const uint8_t *value)

    Returns a new :py:class:`U8Vector3` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads 3 uint8_ts from the pointer.


.. c:function:: const uint8_t *U8Vector3_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`U8Vector3`. The lifetime of this
    pointer is tied to the :py:class:`U8Vector3` object.
