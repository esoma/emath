...
.. py:class:: BVector3Array

    .. py:method:: __init__(*vectors: BVector3)

        Initializes a BVector3Array composed of the vectors provided.
    ...
    .. py:method:: count(value: BVector3) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: BVector3, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`BVector3Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`bool[3 * length]`.
    ...
    .. py:method:: get_component_type() -> type[BVector3]
        :classmethod:
...
.. c:function:: PyObject *BVector3Array_Create(size_t length, const bool *value)

    Returns a new :py:class:`BVector3Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`3 * length` bools from the pointer.


.. c:function:: const bool *BVector3Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`BVector3Array`. The lifetime of this
    pointer is tied to the :py:class:`BVector3Array` object.


.. c:function:: size_t BVector3Array_GetLength()

    Returns the number of vectors in the :py:class:`BVector3Array` object.


.. c:function:: PyTypeObject *BVector3Array_GetType()

    Returns the type object of :py:class:`BVector3Array`.
