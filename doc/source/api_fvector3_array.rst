...
.. py:class:: FVector3Array

    .. py:method:: __init__(*vectors: FVector3)

        Initializes a FVector3Array composed of the vectors provided.
    ...
    .. py:method:: count(value: FVector3) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: FVector3, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`FVector3Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`float[3 * length]`.
    ...
    .. py:method:: get_component_type() -> type[FVector3]
        :classmethod:
...
.. c:function:: PyObject *FVector3Array_Create(size_t length, const float *value)

    Returns a new :py:class:`FVector3Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`3 * length` floats from the pointer.


.. c:function:: const float *FVector3Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`FVector3Array`. The lifetime of this
    pointer is tied to the :py:class:`FVector3Array` object.


.. c:function:: size_t FVector3Array_GetLength()

    Returns the number of vectors in the :py:class:`FVector3Array` object.


.. c:function:: PyTypeObject *FVector3Array_GetType()

    Returns the type object of :py:class:`FVector3Array`.
