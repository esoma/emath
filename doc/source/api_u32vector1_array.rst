...
.. py:class:: U32Vector1Array

    .. py:method:: __init__(*vectors: U32Vector1)

        Initializes a U32Vector1Array composed of the vectors provided.
    ...
    .. py:method:: count(value: U32Vector1) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: U32Vector1, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`U32Vector1Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`uint32_t[1 * length]`.
    ...
    .. py:method:: get_component_type() -> type[U32Vector1]
        :classmethod:
    ...
    .. py:method:: from_buffer(buffer: Buffer, /) -> U32Vector1
        ...
        :code:`uint32_t[1 * length]`.


C API
-----

.. c:function:: PyObject *U32Vector1Array_Create(size_t length, const uint32_t *value)

    Returns a new :py:class:`U32Vector1Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`1 * length` uint32_ts from the pointer.


.. c:function:: const uint32_t *U32Vector1Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`U32Vector1Array`. The lifetime of this
    pointer is tied to the :py:class:`U32Vector1Array` object.


.. c:function:: size_t U32Vector1Array_GetLength()

    Returns the number of vectors in the :py:class:`U32Vector1Array` object.


.. c:function:: PyTypeObject *U32Vector1Array_GetType()

    Returns the type object of :py:class:`U32Vector1Array`.
