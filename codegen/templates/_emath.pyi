...
class {{ type }}Array:
    ...
    def count(self, value: {{ type }}) -> int: ...
    def index(self, value: {{ type }}, start: int = 0, stop: int = -1) -> int: ...
...
{% if row_size == 4 and column_size == 4 %}
    ...
    @classmethod
    def perspective_rh_zo(cls, fov: float, aspect_ratio: float, near: float, far: float, /) -> {{ type }}: ...
    @classmethod
    def perspective_rh_no(cls, fov: float, aspect_ratio: float, near: float, far: float, /) -> {{ type }}: ...
    @classmethod
    def orthographic(cls, left: float, right: float, top: float, bottom: float, near: float, far: float, /) -> {{ type }}: ...
    @classmethod
    def orthographic_rh_zo(cls, left: float, right: float, top: float, bottom: float, near: float, far: float, /) -> {{ type }}: ...
    @classmethod
    def orthographic_rh_no(cls, left: float, right: float, top: float, bottom: float, near: float, far: float, /) -> {{ type }}: ...
    @classmethod
...
class {{ type }}:
    ...
    @property
    def euler_angles(self) -> {{ type[0] }}Vector3: ...
...
class {{ type }}Array:
    ...
    def count(self, value: {{ pod_type }}) -> int: ...
    def index(self, value: {{ pod_type }}, start: int = 0, stop: int = -1) -> int: ...
