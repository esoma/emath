...
.. py:class:: UVector4
    ...
    .. py:method:: __init__()
        ...
        Initializes a UVector4 with :code:`0` in all component positions.


    .. py:method:: __init__(all: Number, /)
        :no-index:

        Initializes a UVector4 with :code:`all` in all component positions.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`UVector4` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`unsigned int[4]`.
    ...
    .. py:method:: __add__(other: UVector4) -> UVector4

        Add the two vectors together, component-wise.


    .. py:method:: __add__(other: Number) -> UVector4
        :no-index:

        Add the number to each component of the vector.


    .. py:method:: __sub__(other: UVector4) -> UVector4

        Subtract two vectors from each other, component-wise.


    .. py:method:: __sub__(other: Number) -> UVector4
        :no-index:

        Subtract the number from each component of the vector.


    .. py:method:: __mul__(other: UVector4) -> UVector4

        Multiple the two vectors, component-wise.


    .. py:method:: __mul__(other: Number) -> UVector4
        :no-index:
    ...
    .. py:method:: __truediv__(other: UVector4) -> UVector4

        Divide the two vectors, component-wise.


    .. py:method:: __truediv__(other: Number) -> UVector4
        :no-index:
    ...
    .. py:method:: get_array_type() -> type[UVector4Array]
        :classmethod:
...
.. c:function:: PyObject *UVector4_Create(const unsigned int *value)

    Returns a new :py:class:`UVector4` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads 4 unsigned ints from the pointer.


.. c:function:: const unsigned int *UVector4_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`UVector4`. The lifetime of this
    pointer is tied to the :py:class:`UVector4` object.


.. c:function:: PyTypeObject *UVector4_GetType()

    Returns the type object of :py:class:`UVector4`.
