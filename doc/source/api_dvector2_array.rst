...
.. py:class:: DVector2Array

    .. py:method:: __init__(*vectors: DVector2)

        Initializes a DVector2Array composed of the vectors provided.
    ...
    .. py:method:: count(value: DVector2) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: DVector2, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`DVector2Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`double[2 * length]`.
    ...
    .. py:method:: get_component_type() -> type[DVector2]
        :classmethod:
    ...
    .. py:method:: from_buffer(buffer: Buffer, /) -> DVector2
        ...
        :code:`double[2 * length]`.


C API
-----

.. c:function:: PyObject *DVector2Array_Create(size_t length, const double *value)

    Returns a new :py:class:`DVector2Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`2 * length` doubles from the pointer.


.. c:function:: const double *DVector2Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`DVector2Array`. The lifetime of this
    pointer is tied to the :py:class:`DVector2Array` object.


.. c:function:: size_t DVector2Array_GetLength()

    Returns the number of vectors in the :py:class:`DVector2Array` object.


.. c:function:: PyTypeObject *DVector2Array_GetType()

    Returns the type object of :py:class:`DVector2Array`.
