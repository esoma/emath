...
.. py:class:: I8Vector3Array

    .. py:method:: __init__(*vectors: I8Vector3)

        Initializes a I8Vector3Array composed of the vectors provided.
    ...
    .. py:method:: count(value: I8Vector3) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: I8Vector3, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`I8Vector3Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`int8_t[3 * length]`.
    ...
    .. py:method:: get_component_type() -> type[I8Vector3]
        :classmethod:
    ...
    .. py:method:: from_buffer(buffer: Buffer, /) -> I8Vector3
        ...
        :code:`int8_t[3 * length]`.


C API
-----

.. c:function:: PyObject *I8Vector3Array_Create(size_t length, const int8_t *value)

    Returns a new :py:class:`I8Vector3Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`3 * length` int8_ts from the pointer.


.. c:function:: const int8_t *I8Vector3Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`I8Vector3Array`. The lifetime of this
    pointer is tied to the :py:class:`I8Vector3Array` object.


.. c:function:: size_t I8Vector3Array_GetLength()

    Returns the number of vectors in the :py:class:`I8Vector3Array` object.


.. c:function:: PyTypeObject *I8Vector3Array_GetType()

    Returns the type object of :py:class:`I8Vector3Array`.
