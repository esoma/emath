...
.. py:class:: I64Vector4
    ...
    .. py:method:: __init__()
        ...
        Initializes a I64Vector4 with :code:`0` in all component positions.


    .. py:method:: __init__(all: Number, /)
        :no-index:

        Initializes a I64Vector4 with :code:`all` in all component positions.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`I64Vector4` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`int64_t[4]`.
    ...
    .. py:method:: __add__(other: I64Vector4) -> I64Vector4

        Add the two vectors together, component-wise.


    .. py:method:: __add__(other: Number) -> I64Vector4
        :no-index:

        Add the number to each component of the vector.


    .. py:method:: __sub__(other: I64Vector4) -> I64Vector4

        Subtract two vectors from each other, component-wise.


    .. py:method:: __sub__(other: Number) -> I64Vector4
        :no-index:

        Subtract the number from each component of the vector.


    .. py:method:: __mul__(other: I64Vector4) -> I64Vector4

        Multiple the two vectors, component-wise.


    .. py:method:: __mul__(other: Number) -> I64Vector4
        :no-index:
    ...
    .. py:method:: __truediv__(other: I64Vector4) -> I64Vector4

        Divide the two vectors, component-wise.


    .. py:method:: __truediv__(other: Number) -> I64Vector4
        :no-index:
    ...
    .. py:method:: get_array_type() -> type[I64Vector4Array]
        :classmethod:

        Returns the emath class used to create an array of this vector type.


    .. py:method:: from_buffer(buffer: Buffer, /) -> I64Vector4
        :classmethod:
...
.. c:function:: PyObject *I64Vector4_Create(const int64_t *value)

    Returns a new :py:class:`I64Vector4` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads 4 int64_ts from the pointer.


.. c:function:: const int64_t *I64Vector4_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`I64Vector4`. The lifetime of this
    pointer is tied to the :py:class:`I64Vector4` object.


.. c:function:: PyTypeObject *I64Vector4_GetType()

    Returns the type object of :py:class:`I64Vector4`.
