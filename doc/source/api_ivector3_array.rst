...
.. py:class:: IVector3Array

    .. py:method:: __init__(*vectors: IVector3)

        Initializes a IVector3Array composed of the vectors provided.
    ...
    .. py:method:: count(value: IVector3) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: IVector3, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`IVector3Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`int[3 * length]`.
    ...
    .. py:method:: get_component_type() -> type[IVector3]
        :classmethod:
...
.. c:function:: PyObject *IVector3Array_Create(size_t length, const int *value)

    Returns a new :py:class:`IVector3Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`3 * length` ints from the pointer.


.. c:function:: const int *IVector3Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`IVector3Array`. The lifetime of this
    pointer is tied to the :py:class:`IVector3Array` object.


.. c:function:: size_t IVector3Array_GetLength()

    Returns the number of vectors in the :py:class:`IVector3Array` object.


.. c:function:: PyTypeObject *IVector3Array_GetType()

    Returns the type object of :py:class:`IVector3Array`.
