...
.. py:class:: IVector4
    ...
    .. py:method:: __init__()
        ...
        Initializes a IVector4 with :code:`0` in all component positions.


    .. py:method:: __init__(all: Number, /)
        :no-index:

        Initializes a IVector4 with :code:`all` in all component positions.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`IVector4` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`int[4]`.
    ...
    .. py:method:: __add__(other: IVector4) -> IVector4

        Add the two vectors together, component-wise.


    .. py:method:: __add__(other: Number) -> IVector4
        :no-index:

        Add the number to each component of the vector.


    .. py:method:: __sub__(other: IVector4) -> IVector4

        Subtract two vectors from each other, component-wise.


    .. py:method:: __sub__(other: Number) -> IVector4
        :no-index:

        Subtract the number from each component of the vector.


    .. py:method:: __mul__(other: IVector4) -> IVector4

        Multiple the two vectors, component-wise.


    .. py:method:: __mul__(other: Number) -> IVector4
        :no-index:
    ...
    .. py:method:: __truediv__(other: IVector4) -> IVector4

        Divide the two vectors, component-wise.


    .. py:method:: __truediv__(other: Number) -> IVector4
        :no-index:
    ...
    .. py:method:: get_array_type() -> type[IVector4Array]
        :classmethod:

        Returns the emath class used to create an array of this vector type.


    .. py:method:: from_buffer(buffer: Buffer, /) -> IVector4
        :classmethod:
...
.. c:function:: PyObject *IVector4_Create(const int *value)

    Returns a new :py:class:`IVector4` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads 4 ints from the pointer.


.. c:function:: const int *IVector4_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`IVector4`. The lifetime of this
    pointer is tied to the :py:class:`IVector4` object.


.. c:function:: PyTypeObject *IVector4_GetType()

    Returns the type object of :py:class:`IVector4`.
