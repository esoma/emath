...
.. py:class:: U16Vector2Array

    .. py:method:: __init__(*vectors: U16Vector2)

        Initializes a U16Vector2Array composed of the vectors provided.
    ...
    .. py:method:: count(value: U16Vector2) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: U16Vector2, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`U16Vector2Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`uint16_t[2 * length]`.
    ...
    .. py:method:: get_component_type() -> type[U16Vector2]
        :classmethod:
    ...
    .. py:method:: from_buffer(buffer: Buffer, /) -> U16Vector2
        ...
        :code:`uint16_t[2 * length]`.


C API
-----

.. c:function:: PyObject *U16Vector2Array_Create(size_t length, const uint16_t *value)

    Returns a new :py:class:`U16Vector2Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`2 * length` uint16_ts from the pointer.


.. c:function:: const uint16_t *U16Vector2Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`U16Vector2Array`. The lifetime of this
    pointer is tied to the :py:class:`U16Vector2Array` object.


.. c:function:: size_t U16Vector2Array_GetLength()

    Returns the number of vectors in the :py:class:`U16Vector2Array` object.


.. c:function:: PyTypeObject *U16Vector2Array_GetType()

    Returns the type object of :py:class:`U16Vector2Array`.
