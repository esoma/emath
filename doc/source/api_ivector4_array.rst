...
.. py:class:: IVector4Array

    .. py:method:: __init__(*vectors: IVector4)

        Initializes a IVector4Array composed of the vectors provided.
    ...
    .. py:method:: count(value: IVector4) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: IVector4, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`IVector4Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`int[4 * length]`.
    ...
    .. py:method:: get_component_type() -> type[IVector4]
        :classmethod:
...
.. c:function:: PyObject *IVector4Array_Create(size_t length, const int *value)

    Returns a new :py:class:`IVector4Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`4 * length` ints from the pointer.


.. c:function:: const int *IVector4Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`IVector4Array`. The lifetime of this
    pointer is tied to the :py:class:`IVector4Array` object.


.. c:function:: size_t IVector4Array_GetLength()

    Returns the number of vectors in the :py:class:`IVector4Array` object.


.. c:function:: PyTypeObject *IVector4Array_GetType()

    Returns the type object of :py:class:`IVector4Array`.
