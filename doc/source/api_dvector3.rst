...
.. py:class:: DVector3
    ...
    .. py:method:: __init__()
        ...
        Initializes a DVector3 with :code:`0` in all component positions.


    .. py:method:: __init__(all: Number, /)
        :no-index:

        Initializes a DVector3 with :code:`all` in all component positions.
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`DVector3` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`double[3]`.
    ...
    .. py:method:: __add__(other: DVector3) -> DVector3

        Add the two vectors together, component-wise.


    .. py:method:: __add__(other: Number) -> DVector3
        :no-index:

        Add the number to each component of the vector.


    .. py:method:: __sub__(other: DVector3) -> DVector3

        Subtract two vectors from each other, component-wise.


    .. py:method:: __sub__(other: Number) -> DVector3
        :no-index:

        Subtract the number from each component of the vector.


    .. py:method:: __mul__(other: DVector3) -> DVector3

        Multiple the two vectors, component-wise.


    .. py:method:: __mul__(other: Number) -> DVector3
        :no-index:
    ...
    .. py:method:: __truediv__(other: DVector3) -> DVector3

        Divide the two vectors, component-wise.


    .. py:method:: __truediv__(other: Number) -> DVector3
        :no-index:
    ...
    .. py:method:: get_array_type() -> type[DVector3Array]
        :classmethod:
...
.. c:function:: PyObject *DVector3_Create(const double *value)

    Returns a new :py:class:`DVector3` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads 3 doubles from the pointer.


.. c:function:: const double *DVector3_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`DVector3`. The lifetime of this
    pointer is tied to the :py:class:`DVector3` object.
