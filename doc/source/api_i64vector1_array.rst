...
.. py:class:: I64Vector1Array

    .. py:method:: __init__(*vectors: I64Vector1)

        Initializes a I64Vector1Array composed of the vectors provided.
    ...
    .. py:method:: count(value: I64Vector1) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: I64Vector1, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`I64Vector1Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`int64_t[1 * length]`.
    ...
    .. py:method:: get_component_type() -> type[I64Vector1]
        :classmethod:
    ...
    .. py:method:: from_buffer(buffer: Buffer, /) -> I64Vector1
        ...
        :code:`int64_t[1 * length]`.


C API
-----

.. c:function:: PyObject *I64Vector1Array_Create(size_t length, const int64_t *value)

    Returns a new :py:class:`I64Vector1Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`1 * length` int64_ts from the pointer.


.. c:function:: const int64_t *I64Vector1Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`I64Vector1Array`. The lifetime of this
    pointer is tied to the :py:class:`I64Vector1Array` object.


.. c:function:: size_t I64Vector1Array_GetLength()

    Returns the number of vectors in the :py:class:`I64Vector1Array` object.


.. c:function:: PyTypeObject *I64Vector1Array_GetType()

    Returns the type object of :py:class:`I64Vector1Array`.
