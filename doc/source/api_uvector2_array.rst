...
.. py:class:: UVector2Array

    .. py:method:: __init__(*vectors: UVector2)

        Initializes a UVector2Array composed of the vectors provided.
    ...
    .. py:method:: count(value: UVector2) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: UVector2, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`UVector2Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`unsigned int[2 * length]`.
    ...
    .. py:method:: get_component_type() -> type[UVector2]
        :classmethod:
    ...
    .. py:method:: from_buffer(buffer: Buffer, /) -> UVector2
        ...
        :code:`unsigned int[2 * length]`.


C API
-----

.. c:function:: PyObject *UVector2Array_Create(size_t length, const unsigned int *value)

    Returns a new :py:class:`UVector2Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`2 * length` unsigned ints from the pointer.


.. c:function:: const unsigned int *UVector2Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`UVector2Array`. The lifetime of this
    pointer is tied to the :py:class:`UVector2Array` object.


.. c:function:: size_t UVector2Array_GetLength()

    Returns the number of vectors in the :py:class:`UVector2Array` object.


.. c:function:: PyTypeObject *UVector2Array_GetType()

    Returns the type object of :py:class:`UVector2Array`.
