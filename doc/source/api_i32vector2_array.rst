...
.. py:class:: I32Vector2Array

    .. py:method:: __init__(*vectors: I32Vector2)

        Initializes a I32Vector2Array composed of the vectors provided.
    ...
    .. py:method:: count(value: I32Vector2) -> int

        Return the number of occurrences of the given vector in the array.

    .. py:method:: index(value: I32Vector2, start: int = 0, stop: int | None = None) -> int
    ...
    .. py:method:: __eq__(other: Any) -> bool
        ...
        The other object must also be a :py:class:`I32Vector2Array` in order to pass as :code:`True`.
    ...
    .. py:method:: __buffer__(flags: int) -> memoryview
        ...
        The C data-type equivalent for the buffer is :code:`int32_t[2 * length]`.
    ...
    .. py:method:: get_component_type() -> type[I32Vector2]
        :classmethod:
    ...
    .. py:method:: from_buffer(buffer: Buffer, /) -> I32Vector2
        ...
        :code:`int32_t[2 * length]`.


C API
-----

.. c:function:: PyObject *I32Vector2Array_Create(size_t length, const int32_t *value)

    Returns a new :py:class:`I32Vector2Array` object or :code:`0` on failure.
    Data from the value pointer is copied.
    Note that the function reads :code:`2 * length` int32_ts from the pointer.


.. c:function:: const int32_t *I32Vector2Array_GetValuePointer(const PyObject *vector)

    Returns a pointer to the data represented by :py:class:`I32Vector2Array`. The lifetime of this
    pointer is tied to the :py:class:`I32Vector2Array` object.


.. c:function:: size_t I32Vector2Array_GetLength()

    Returns the number of vectors in the :py:class:`I32Vector2Array` object.


.. c:function:: PyTypeObject *I32Vector2Array_GetType()

    Returns the type object of :py:class:`I32Vector2Array`.
